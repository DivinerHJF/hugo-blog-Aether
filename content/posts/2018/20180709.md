...
description: "R Markdown 使用笔记，介绍通过 knitr 与 Pandoc 生成数据报告的基础流程。"
...
这里假设您已经安装了 R ([https://www.r-project.org](https://www.r-project.org/))  和 RStudio IDE ([https://www.rstudio.com](https://www.rstudio.com/)) 。Rstudio 并不是必须的，但安装它会使您更加容易地使用 R Markdown。如果您没有安装 RStudio IDE，您将不得不安装 Pandoc（ [https://pandoc.org](https://pandoc.org) ），否则就不需要单独安装 Pandoc，因为在安装 RStudio 时已经将它捆绑安装了。接下来，您可以在 R 中安装 `rmarkdown` 包：
...
![Tabbed sections](https://img.philohao.com/blog/2018/07/20180709-01.webp)
...
![mtcars](https://img.philohao.com/blog/2018/07/20180709-02.webp)
...
有关模板的其他详细信息，请参考 [Pandoc 模板](https://pandoc.org/MANUAL.html#templates) 上的文档。您还可以研究默认的 HTML 模板 [`default.html5`](https://github.com/jgm/pandoc-templates/) 。
