...
description: "MySQL 函数学习笔记，整理空值处理、字符串、日期和聚合函数用法。"
date: 2020-02-18T23:46:13+08:00
categories: [技术笔记]
series: [SQL 数据库笔记]
tags: [SQL, 数据库]
comment: true
...
有关上述函数的具体使用，可以参考：[https://www.runoob.com/sql/sql-function.html](https://www.runoob.com/sql/sql-function.html)
