...
当前配置和内容实际触发的库包括 Fuse/autocomplete、KaTeX、APlayer/Meting、TypeIt、FontAwesome，以及足迹相册使用的 PhotoSwipe 5.4.4。PhotoSwipe 的版本记录在 `themes/aether/assets/lib/VERSION`，主题构建前会校验它没有漂移。
